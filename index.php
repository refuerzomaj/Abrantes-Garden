...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	$sql_p="SELECT id FROM users WHERE name='$username'";
	...
	if (mysqli_num_rows($result) > 0) {
		...
		$user_id = $row['id'];
		$query=mysqli_query($con,"INSERT INTO cart(user_id,item_id) values('$user_id','$id')");
		if($query)
		{
		...
		// Display the ID
		echo "The ID of the user with name '$name' is: $id";
	} else {
...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/pp.ico">
...
<div class="title-section">
	<div>
		...
		<div class="button-start">
			<a href="#top-banner-and-menu">Shop Now</a>
		</div>
	</div>
</div>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/bg1.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/bg2.jpeg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/bg3.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">free shipping <?php echo $username;?></h4>
						</div>
					</div>
					<h6 class="text">free ship-on oder over 0 minimum spend!</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#flower" data-toggle="tab">FLOWERING PLANTS</a></li>
					<li><a href="#fruit" data-toggle="tab">FRUIT SHRUBS </a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Ornamentals</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from products where category=13 and subCategory=35");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">FRUIT PLANTS</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=14 and subCategory=36");
while ($row=mysqli_fetch_array($ret)) 
{
?>
