...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/banner5.png" alt="" class="img-responsive">
			</div>
	...
	<script>
		window.onscroll = function() {scrollFunction()};
			...
			if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
				...
				containers.forEach(function(container) {container.style.padding = "30px 0";});
				containers.forEach(function(container) {container.style.background = "#42730673";});
